...
public class WindowVaccinationInfo
{
	...
	{
		JLabel labelTitulo = new JLabel("Informa��o Vacina��o");
	...
	public WindowVaccinationInfo()
	{
		...
		String titleFirstDose = "N� de primeiras doses: ";
		String valueFirstDose;
		String titleAppliedDose = "Doses Aplicadas: ";
		String valueAppliedDose;
		String titleSecondDose = "N� de segundas doses: ";
		String valueSecondDose;
		String titleOnlyDose = "N� de doses �nicas: ";
